...
@Disabled
@Autonomous(name = "GNU!!", group = "Auto")
public class GNUMechAuto extends LinearOpMode {
    public enum Location {
        LEFT, CENTER, RIGHT;
    }

    private OpenCvInternalCamera phoneCam;
    private GNUMechAuto.StageSwitchingPipeline stageSwitchingPipeline;
    ...
    public void runOpMode() {
        ...
        stageSwitchingPipeline = new GNUMechAuto.StageSwitchingPipeline();
