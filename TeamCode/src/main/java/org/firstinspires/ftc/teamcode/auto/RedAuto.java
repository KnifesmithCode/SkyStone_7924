...
public class RedAuto extends TunableLinearOpMode {
    ...
    static class SkystonePipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            // Left stone
            Rect leftStoneRect = new Rect(x, y, 5, 5);
            ...
            // Center stone
            Rect centerStoneRect = new Rect(x, HEIGHT / 2, 5, 5);
            ...
            // Right stone
            Rect rightStoneRect = new Rect(x, HEIGHT / 2, 5, 5);
